%checks if all algos are working by optimizing cec2017 func 1

CP_no=120; % Number of search agents (crested porcupines)
RUN_NO=30; % Number of independent runs
dim=10;
test_result_filename = "test_results\functionality_test_results.csv";
convergence_data_folder = "E:\ACPO_Convergence_Curves_Raw\functionality_test";
...
for optim = classical_optimizers
